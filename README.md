...
- the Postgresql should be installed in your machine.

### Setup

Clone this repository to your desired folder:

- `git clone https://github.com/najibullahjafari/vet-clininc`
...
Feel free to check the [issues page](https://github.com/najibullahjafari/vet-clininc/issues/).
